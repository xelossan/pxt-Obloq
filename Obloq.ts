...
namespace Obloq {
    ...
    */
    ...
    /**
     * Create IoT client
     * @param hubName to hubName
     * @param deviceId to deviceId
     * @param deviceKey to deviceKey
     */
    //% blockId=Obloq_createIotClient
    //% block="iot hub connect | hub name %hubName | device Id %deviceId | device key %deviceKey"
    export function Obloq_createIotClient(hubName: string, deviceId: string, deviceKey: string): void {
        let connectionString = `HostName=${OBLOQ_IOT_TOPIC}.azure-devices.net;DeviceId=${OBLOQ_IOT_ID};SharedAccessKey=${OBLOQ_IOT_PWD};GatewayHostName=192.168.1.225`;
        obloqWriteString(`|4|2|1|${connectionString}|`);
    }
